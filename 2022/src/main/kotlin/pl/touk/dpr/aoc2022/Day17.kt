...
object Day17 {
    ...
    fun main(args: Array<String>) = Util.measureTime {
        ...
        println("Part 1:")
        println(part1And2(Util.getNotEmptyLinesFromFile("/17/test1.txt"), 2022L, null, false))
        println(part1And2(lines, 2022L, null, false))
        println("Part 2:")
        ...
        println(part1And2(Util.getNotEmptyLinesFromFile("/17/test1.txt"), part2TurnLimit, exampleMaskRaw, false))
        val inputMaskRaw = """
            ...3...
            ..23...
            ..23...
            ...
            .10000.
        """.trimIndent()
        println(part1And2(lines, part2TurnLimit, inputMaskRaw, print = false))
    }
    ...
    private fun part1And2(lines: List<String>, limit: Long, maskRaw: String?, print: Boolean = false): Any {
