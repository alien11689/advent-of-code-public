...
//        printClays(claysSet, filled, drained)
    ...
    fun goDown(
        ...
        var boundLeft = fillLeft(x, claysSet, y, filled, drained, visitedDown)
        var boundRight = fillRight(x, claysSet, y, filled, drained, visitedDown)
        while (boundLeft.type == ActionType.GoUp && boundRight.type == ActionType.GoUp) {
            ...
            --y
            filled.add(x to y)
            boundLeft = fillLeft(x, claysSet, y, filled, drained, visitedDown)
            boundRight = fillRight(x, claysSet, y, filled, drained, visitedDown)
        }
